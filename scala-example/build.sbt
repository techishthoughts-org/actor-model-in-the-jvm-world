...
lazy val root = (project in file(".")) // Define the root project
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "com.typesafe.akka" %% "akka-actor" % "2.6.21", // Add Akka actor
      "com.typesafe.akka" %% "akka-slf4j" % "2.6.21", // Add SLF4J logging for Akka
      "com.typesafe.akka" %% "akka-testkit" % "2.6.21" % Test, // Add Akka TestKit for testing
      ...
      "com.typesafe.akka" %% "akka-stream" % "2.6.21", // Add Akka Streams for HTTP
